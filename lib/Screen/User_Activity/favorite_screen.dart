  ...
  Widget build(BuildContext context) {
   ...
   final provider = ref.watch(favoriteProvider);
    return Scaffold(
      ...
      body:
          userId == null
              ? Center(child: Text("Please logi to viwe favorites"))
                ...
                builder: (context, snapshot) {
                  ...
                  return FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final favoritesItens = snapshot.data!;
                      if (favoritesItens.isEmpty) {
                        return Center(child: Text("No favorites yet"));
                      }
                      return ListView.builder(
                        itemCount: favoritesItens.length,
                        itemBuilder: (context, index) {
                          final FoodModel items = favoritesItens[index];
                          return Stack(
                            children: [
                              Padding(
